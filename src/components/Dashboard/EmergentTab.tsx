...
const EmergentTab = () => {
  ...
  const handleApprove = async (issue: Proposal) => {
    try {
  ...
  return (
    <div className="p-4 space-y-4 font-mono">
      ...
      <div className="space-y-3">
        ...
        {proposals.length === 0 && !isScanning && (
          <p className="text-[10px] text-gray-600 text-center py-10 uppercase tracking-widest">No Active Proposals</p>
        )}
      </div>
    </div>
  );
