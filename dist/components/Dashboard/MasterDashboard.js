...
const MasterDashboard = () => {
    const [stats, setStats] = (0, react_1.useState)({ agent_count: 0, project_count: 0, export_count: 0 });
    (0, react_1.useEffect)(() => {
    ...
    return (<div className="p-5 space-y-4">
      ...
      <div className="flex items-center gap-3 bg-blue-600/10 border border-blue-500/20 p-4 rounded-3xl">
        <lucide_react_1.ShieldCheck className="text-blue-500" size={32}/>
        <div>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-[#0a0a0a] border border-gray-900 p-3 rounded-2xl text-center">
          <lucide_react_1.Users size={16} className="text-emerald-500 mx-auto mb-1"/>
        ...
        <div className="bg-[#0a0a0a] border border-gray-900 p-3 rounded-2xl text-center">
          <lucide_react_1.Box size={16} className="text-blue-500 mx-auto mb-1"/>
        ...
        <div className="bg-[#0a0a0a] border border-gray-900 p-3 rounded-2xl text-center">
          <lucide_react_1.DownloadCloud size={16} className="text-amber-500 mx-auto mb-1"/>
      ...
      <button className="w-full bg-white text-black font-black py-4 rounded-2xl text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 active:scale-95 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)]">
        <lucide_react_1.Zap size={14} fill="black"/> Emergency_Global_Export
      </button>
    </div>);
};
