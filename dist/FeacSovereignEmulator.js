...
class FeacSovereignEmulator {
    ...
    async simulateLogin() {
        ...
        const res = await axios_1.default.post(`${CONFIG.bridgeUrl}/api/validate-key`, { apiKey: CONFIG.ownerKey });
        if (res.data.success) {
