    ...
    <div className="p-5 pb-24 space-y-6">
      ...
      {repos.map((repo) => (
        <div key={repo.id} className="bg-[#111821] border border-gray-800 rounded-2xl p-5 space-y-4">
          ...
          <input type="password" className="w-full bg-black/40 border border-gray-800 p-3 rounded-xl text-xs text-emerald-500" placeholder="GitHub Token" />
          
          {/* Kolom Prompt Per Repo */}
          <div className="relative group">
            <textarea className="w-full bg-black border border-blue-900/30 p-4 rounded-xl text-xs text-gray-300 focus:border-blue-500 outline-none h-24" placeholder="Instruction for this repo (e.g. 'Fix all async errors and optimize imports')" />
